...
from bot.config import MODEL_ID, TZ, gemini_client, log
...
async def process_ai_message(message, content):
    ...
    try:
        ...
        await message.answer(f"⚠️ Ошибка: {str(e)[:200]}", reply_markup=main_keyboard)
